...
#define REGS_H_
	...
	*/
	...
	//!< ///////////////////   SSP1   /////////////////////////////
	#define		SSP1 			( ( registro  * ) 0x40030000UL )


#define 	SSP1CR0		SSP1[0] 	//Control Register 0.
#define 	SSP1CR1		SSP1[1] 	//Control Register 1.
#define 	SSP1DR		SSP1[2] 	//Data Register.
#define 	SSP1SR		SSP1[3] 	//Status Register.
#define 	SSP1CPSR	SSP1[4] 	//Clock Prescale Register.
#define 	SSP1IMSC	SSP1[5] 	//Interrupt Mask Set and Clear Register.
#define 	SSP1RIS		SSP1[6] 	//Raw Interrupt Status Register.
#define 	SSP1MIS		SSP1[7] 	//Masked Interrupt Status Register.
#define 	SSP1ICR		SSP1[8] 	//SSPICR Interrupt Clear Register.
#define 	SSP1DMACR	SSP1[9] 	//DMA Control Register.




//Registros del DMA:
//0x50004020CUL: Registro de peticiones de Burst Transfers:
#define DIR_DMACSoftBReq	( (uint32_t *) 0x50004020UL)
//0x50004024CUL: Registro de peticiones de Single Transfers:
#define DIR_DMACSoftSReq	( (uint32_t *) 0x50004024UL)
//0x50004030CUL: Registro de configuracion del DMA:
#define DIR_DMACConfig	( (uint32_t *) 0x50004030UL)

//Registros del canal0 del dma:
//0x50004008UL: Registro de Clear de las interrupciones del DMA:
#define DIR_DMACIntTCClear	( (uint32_t *) 0x50004008UL)
//0x50004100CUL: Registro de SrcAdress del canal0:
#define DIR_DMACC0SrcAddr	( (uint32_t *) 0x50004100UL)
//0x50004104CUL: Registro de DestAdress del canal0:
#define DIR_DMACC0DestAddr	( (uint32_t *) 0x50004104UL)
//0x50004108CUL: Registro de LLI del canal0:
#define DIR_DMACC0LLI	( (uint32_t *) 0x50004108UL)
//0x5000410CCUL: Registro de Control del canal0:
#define DIR_DMACC0Control	( (uint32_t *) 0x5000410CUL)
//0x50004110CUL: Registro de Configuracion del canal0:
#define DIR_DMACC0Config	( (uint32_t *) 0x50004110UL)
//0x50004034CUL: Registro de sincronismo del DMA:
#define DIR_DMACSync	( (uint32_t *) 0x50004034UL)


//DMA:
#define DMACIntTCClear	DIR_DMACIntTCClear[0]
#define DMACSoftBReq	DIR_DMACSoftBReq[0]
#define DMACSoftSReq	DIR_DMACSoftSReq[0]
#define DMACConfig		DIR_DMACConfig[0]
#define DMACSync		DIR_DMACSync[0]

//Canal0 del dma:
#define DMACC0SrcAddr	DIR_DMACC0SrcAddr[0]
#define DMACC0DestAddr	DIR_DMACC0DestAddr[0]
#define DMACC0LLI		DIR_DMACC0LLI[0]
#define DMACC0Control	DIR_DMACC0Control[0]
#define DMACC0Config	DIR_DMACC0Config[0]
